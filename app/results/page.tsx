      ...
      <main className="relative z-10 pt-32 pb-20 px-6 max-w-7xl mx-auto text-white">
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-blue-200 to-blue-400 bg-clip-text text-transparent">
            What Happens When AI<br />Runs Your Business
          </h1>
          <p className="text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto">
            Real transformations. Real numbers. See what&apos;s possible when you stop doing everything manually.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                <div>
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold">{study.type}</h2>
              ...
              {/* What We Installed */}
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-blue-400 mb-2">⚡ What We Installed</h3>
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready for Your Transformation?</h2>
