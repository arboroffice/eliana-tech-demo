...
import { RestaurantHeroHeader } from "../../components/restaurant-hero-header"
import { RestaurantSplitScreen } from "../../components/restaurant-split-screen"
...
import { RestaurantWhatsAppDemo } from "../../components/restaurant-whatsapp-demo"
import { RestaurantInstantAnswers } from "../../components/restaurant-instant-answers"
        ...
        <div className="min-h-screen bg-black overflow-hidden">
            <main className="min-h-screen relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <RestaurantSplitScreen />

                    <GrowthStages />
                    <TransformationDemos />
                    <RestaurantInstantAnswers />
                    <RestaurantWhatsAppDemo />
