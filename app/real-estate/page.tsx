...
import { RealEstateHeroHeader } from "../../components/real-estate-hero-header"
import { RealEstateSplitScreen } from "../../components/real-estate-split-screen"
...
import { RealEstateWhatsAppDemo } from "../../components/real-estate-whatsapp-demo"
import { RealEstateInstantAnswers } from "../../components/real-estate-instant-answers"
                ...
                <div className="relative z-10">
                    ...
                    <section className="min-h-screen flex items-start justify-center px-4 pt-24 md:pt-32 pb-20 relative">
                        <div className="max-w-4xl mx-auto text-center relative z-10">
                            ...
                            <RealEstateHeroHeader />
                        </div>
                    </section>

                    <RealEstateSplitScreen />

                    <GrowthStages />
                    <TransformationDemos />
                    <RealEstateInstantAnswers />
                    <RealEstateWhatsAppDemo />
