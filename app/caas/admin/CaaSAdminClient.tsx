...
export default function CaaSAdminClient() {
                    ...
                    <div className="space-y-3">
                      {MOCK_CLIENTS.map(client => (
                        <button
                          ...
                          className="w-full flex items-center justify-between p-4 bg-zinc-900/60 rounded-lg hover:bg-zinc-800/60 transition-colors text-left"
                        >
                          <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-3">
                      {MOCK_CLIENTS.map(client => (
                        <button
                          ...
                          className="w-full bg-zinc-900/40 border border-zinc-800 p-6 rounded-xl flex items-center justify-between hover:border-zinc-700 transition-colors text-left"
                        >
                          <div className="flex items-center gap-6">
