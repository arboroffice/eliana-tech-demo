...
const USE_CASES = [
  ...
  },
  {
    ...
    after: "Claude runs your calendar, meal plans, travel, and family logistics like an elite executive assistant"
  },
]

export default function CaaSClient() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-amber-500/30 overflow-x-hidden antialiased">
      <GlassmorphismNav />
