      ...
      <div className="bg-[#060406] min-h-screen text-[#F2EEF5] font-inter selection:bg-[#D90019] selection:text-white antialiased">
        ...
        <div className="max-w-4xl mx-auto py-10 md:py-16 px-6">
          ...
          <div className="mt-20 pt-20 border-t border-white/[0.04]">
            <p className="text-[10px] tracking-[4px] uppercase text-[#D90019] font-semibold mb-8 flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <a href="http://c12hsh4n5bfc02e5c9p4wyax.187.124.238.237.sslip.io" target="_blank" rel="noopener noreferrer" className="group p-8 bg-white/[0.02] border border-white/[0.07] hover:border-[#D90019]/40 transition-all">
                ...
                <span className="text-[#D90019] text-[11px] font-bold uppercase tracking-widest flex items-center gap-2 group-hover:gap-3 transition-all">Secure Your Briefing →</span>
              </a>
            </div>
          </div>
        </div>
