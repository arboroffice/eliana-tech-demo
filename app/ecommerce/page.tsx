...
import { EcommerceHeroHeader } from "../../components/ecommerce-hero-header"
import { EcommerceSplitScreen } from "../../components/ecommerce-split-screen"
...
import { EcommerceWhatsAppDemo } from "../../components/ecommerce-whatsapp-demo"
import { EcommerceInstantAnswers } from "../../components/ecommerce-instant-answers"
        ...
        <div className="min-h-screen bg-black overflow-hidden">
            <main className="min-h-screen relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <EcommerceSplitScreen />

                    <GrowthStages />
                    <TransformationDemos />
                    <EcommerceInstantAnswers />
                    <EcommerceWhatsAppDemo />
