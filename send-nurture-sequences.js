...
function ctaButton(text, link = CAL_LINK) {
  return `<div style="margin: 32px 0;">
    <a href="${link}" style="display: inline-block; background-color: #000000; color: #ffffff; padding: 16px 32px; border: 1px solid #000000; text-decoration: none; font-weight: 700; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em;">
        ${text}
    </a>
</div>`
}
...
const sequenceD = [
    {
      day: 0,
      subject: 'Sorry we missed each other, {firstName}',
      body: `
<p>Hey {firstName},</p>
...
const sequenceF = [
    {
      day: 0,
      subject: 'Finish your {industry} AI Audit?',
      body: `
<p>Hey {firstName},</p>
...
const sequenceG = [
    {
      day: 0,
      subject: 'Welcome to the Frontier, {firstName}',
      body: `
<p>Hey {firstName},</p>
...
const sequenceH = [
    {
      day: 0,
      subject: 'Checking in on {companyName}',
      body: `
<p>Hey {firstName},</p>
...
<p>Mia</p>
    ...
    {
      day: 30,
      subject: 'A new case study in {industry}',
      body: `
<p>Hey {firstName},</p>
...
<p>Best,<br>Mia</p>
    ...
    {
      day: 60,
      subject: '{firstName}, is this still on your radar?',
      body: `
<p>Hey {firstName},</p>
...
async function run() {
  const replacements = {
    ...
    '{unsubscribeLink}': 'https://elianatech.com/unsubscribe'
  }

  for (const [seqId, emails] of Object.entries(sequences)) {
    for (const email of emails) {
      ...
      console.log(`Sending Sequence ${seqId} Day ${email.day}...`);
  ...
  console.log("All nurture sequences sent!");
}
