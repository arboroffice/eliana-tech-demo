            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                  Clutch by Elianatech handles all your WhatsApp, Messenger, and Instagram DM conversations automatically.
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    ...
                    website, phone, and social media. Clutch By Elianatech manages bookings, answers parts questions, and
