...
import { MessageSquare, Check, ShoppingBag, Shield } from "lucide-react"

export function RetailWhatsAppDemo() {
    const [messages, setMessages] = useState<Array<{ text: string, isUser: boolean, time: string }>>([])
    const containerRef = useRef(null)
    const isInView = useInView(containerRef, { once: true, margin: "-100px" })

    const conversation = [
        { text: "Do you have the new running shoes in size 10 in stock?", isUser: true, delay: 500 },
        { text: "Checking inventory at Downtown Branch...", isUser: false, delay: 1500 },
        { text: "Yes! We have 3 pairs left in size 10. Would you like to reserve a pair for pickup?", isUser: false, delay: 2500 },
        { text: "Yes please, I'll come by after work.", isUser: true, delay: 4000 },
        { text: "Done! I've put them aside under your name. See you soon! 👟", isUser: false, delay: 5000 }
    ]
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div ref={containerRef}>
                        <div className="md:w-[380px] mx-auto bg-white rounded-[2.5rem] p-4 shadow-2xl border-8 border-slate-900 relative">
                            ...
                            <div className="bg-[#075E54] text-white p-4 rounded-t-2xl flex items-center gap-3 pt-8 pb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold">Urban Outfitters</h3>
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Drive Foot Traffic <span className="text-emerald-400">Instantly</span>
                        </h2>
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Connect your physical inventory to digital customers. Answer stock queries, reserve items, and bring online shoppers into your store automatically.
                        </p>
