...
import { MessageSquare, Check, Stethoscope, Shield } from "lucide-react"

export function HealthcareWhatsAppDemo() {
    const [messages, setMessages] = useState<Array<{ text: string, isUser: boolean, time: string }>>([])
    const containerRef = useRef(null)
    const isInView = useInView(containerRef, { once: true, margin: "-100px" })

    const conversation = [
        { text: "Can I get a refill for my prescription?", isUser: true, delay: 500 },
        { text: "Hi! I can help with that. Which medication are you needing to refill?", isUser: false, delay: 1500 },
        { text: "The blood pressure one.", isUser: true, delay: 3000 },
        { text: "Got it. I've sent a request to Dr. Smith for approval. It should be ready at your usual CVS on Main St by 5pm today. Need anything else?", isUser: false, delay: 4500 },
        { text: "No, that's it. Thanks!", isUser: true, delay: 6000 },
        { text: "You're welcome! Stay healthy. 🩺", isUser: false, delay: 7000 }
    ]
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div ref={containerRef}>
                        <div className="md:w-[380px] mx-auto bg-white rounded-[2.5rem] p-4 shadow-2xl border-8 border-slate-900 relative">
                            ...
                            <div className="bg-[#075E54] text-white p-4 rounded-t-2xl flex items-center gap-3 pt-8 pb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold">City Health Clinic</h3>
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Patient Care, <span className="text-emerald-400">Simplified</span>
                        </h2>
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Reduce admin work by 60%. Automate prescription refills, appointment scheduling, and pre-op instructions while keeping human empathy where it matters most.
                        </p>

                        <ul className="space-y-4 mb-10">
                            {[
                                "Automated prescription refills",
                                "Appointment triage & booking",
