...
import { MessageSquare, Check, Clock, Shield } from "lucide-react"

export function DentistWhatsAppDemo() {
    const [messages, setMessages] = useState<Array<{ text: string, isUser: boolean, time: string }>>([])
    const containerRef = useRef(null)
    const isInView = useInView(containerRef, { once: true, margin: "-100px" })

    const conversation = [
        { text: "Hi, do you have any appointments for a cleaning next Tuesday?", isUser: true, delay: 500 },
        { text: "Hello! checking our schedule for next Tuesday...", isUser: false, delay: 1500 },
        { text: "Yes, we have openings at 10:00 AM and 3:30 PM with Sarah. Do either of those work for you?", isUser: false, delay: 2500 },
        { text: "3:30 PM would be perfect.", isUser: true, delay: 4000 },
        { text: "Great! I've booked you for 3:30 PM next Tuesday. You'll receive a confirmation email shortly. See you then! 🦷", isUser: false, delay: 5000 }
    ]
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div ref={containerRef}>
                        <div className="md:w-[380px] mx-auto bg-white rounded-[2.5rem] p-4 shadow-2xl border-8 border-slate-900 relative">
                            ...
                            <div className="bg-[#075E54] text-white p-4 rounded-t-2xl flex items-center gap-3 pt-8 pb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold">Dr. Smith Dental</h3>
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Fill Your Chair <span className="text-emerald-400">Automatically</span>
                        </h2>
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Eliana handles missed calls and messages instantly via WhatsApp. From rescheduling routine cleanings to triage for emergency pain, your AI receptionist ensures no patient is left waiting.
                        </p>
