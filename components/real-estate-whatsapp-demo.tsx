...
import { MessageSquare, Check, Home, Shield } from "lucide-react"

export function RealEstateWhatsAppDemo() {
    ...
    const conversation = [
        ...
        { text: "You're booked for 9am Saturday! I'll send you the access details shortly. 🏠", isUser: false, delay: 7500 }
    ]
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div ref={containerRef}>
                        <div className="md:w-[380px] mx-auto bg-white rounded-[2.5rem] p-4 shadow-2xl border-8 border-slate-900 relative">
                            ...
                            <div className="bg-[#075E54] text-white p-4 rounded-t-2xl flex items-center gap-3 pt-8 pb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold">Prestige Properties</h3>
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Move Listings <span className="text-emerald-400">Faster</span>
                        </h2>
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Connect with buyers instantly. Eliana answers listing questions, books viewings, and pre-qualifies buyers 24/7.
                        </p>

                        <ul className="space-y-4 mb-10">
                            {[
                                "Instant listing details",
