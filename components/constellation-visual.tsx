...
const PLANETS = [
    { name: "CRM", x: 20, y: 20, color: "#dc2626" },     // Red-600
    { name: "Email", x: 80, y: 30, color: "#991b1b" },    // Red-800
    { name: "Calendar", x: 25, y: 75, color: "#ef4444" }, // Red-500
    { name: "Payments", x: 75, y: 70, color: "#b91c1c" }, // Red-700
    { name: "Social", x: 50, y: 15, color: "#f87171" },   // Red-400
    { name: "Analytics", x: 50, y: 85, color: "#7f1d1d" },// Red-900
]
...
export function ConstellationVisual() {
    ...
    return (
        <section className="py-24 bg-black overflow-hidden relative">
            {/* Central Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-red-900/10 rounded-full blur-[100px]" />
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="relative w-full max-w-3xl mx-auto aspect-[4/3] md:aspect-[16/9] lg:h-[600px]">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        ...
                        {/* Central Star (Eliana) */}
                        <div className="w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-red-600 to-red-700 rounded-full shadow-[0_0_50px_rgba(220,38,38,0.5)] flex items-center justify-center relative z-20">
