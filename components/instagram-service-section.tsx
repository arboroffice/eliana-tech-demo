  ...
  const benefits = [
    {
      ...
      description:
        "Clutch By Elianatech automatically schedules service appointments and sends confirmations across all channels - website, phone, and social media, customized to your workflow",
    },
    {
