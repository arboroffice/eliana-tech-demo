...
import { MessageSquare, Check, ShoppingCart, Shield } from "lucide-react"

export function EcommerceWhatsAppDemo() {
    const [messages, setMessages] = useState<Array<{ text: string, isUser: boolean, time: string }>>([])
    const containerRef = useRef(null)
    const isInView = useInView(containerRef, { once: true, margin: "-100px" })

    const conversation = [
        { text: "Where is my order #SH12345?", isUser: true, delay: 500 },
        { text: "Checking status for #SH12345...", isUser: false, delay: 1500 },
        { text: "Good news! It's out for delivery right now. The driver is about 10 stops away.", isUser: false, delay: 2500 },
        { text: "Awesome! Can I change the delivery to leave it at the back door?", isUser: true, delay: 4000 },
        { text: "I've updated the delivery notes for the driver. They'll leave it at the back door. 📦", isUser: false, delay: 5000 }
    ]
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div ref={containerRef}>
                        <div className="md:w-[380px] mx-auto bg-white rounded-[2.5rem] p-4 shadow-2xl border-8 border-slate-900 relative">
                            ...
                            <div className="bg-[#075E54] text-white p-4 rounded-t-2xl flex items-center gap-3 pt-8 pb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold">StyleHouse</h3>
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Support at <span className="text-emerald-400">Scale</span>
                        </h2>
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Reduce support tickets by 80%. Eliana handles WISMO (Where Is My Order), returns, and product questions instantly across WhatsApp, Instagram, and web chat.
                        </p>
