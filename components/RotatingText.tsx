...
import { motion, AnimatePresence, Transition, VariantLabels, TargetAndTransition } from "motion/react"
...
export interface RotatingTextProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'onAnimationStart' | 'onDrag' | 'onDragStart' | 'onDragEnd' | 'onDragEnter' | 'onDragLeave' | 'onDragOver' | 'onDrop'> {
  texts: string[]
