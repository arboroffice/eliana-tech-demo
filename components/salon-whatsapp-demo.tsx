...
import { MessageSquare, Check, Scissors, Shield } from "lucide-react"

export function SalonWhatsAppDemo() {
    const [messages, setMessages] = useState<Array<{ text: string, isUser: boolean, time: string }>>([])
    const containerRef = useRef(null)
    const isInView = useInView(containerRef, { once: true, margin: "-100px" })

    const conversation = [
        { text: "Hey, do you have any slots for a fade and beard trim on Friday?", isUser: true, delay: 500 },
        { text: "Hi! Checking schedule for Friday...", isUser: false, delay: 1500 },
        { text: "Mike is fully booked, but Sarah has openings at 2:00 PM and 4:30 PM. Would you like to grab one?", isUser: false, delay: 2500 },
        { text: "I'll take the 4:30 with Sarah.", isUser: true, delay: 4000 },
        { text: "Locked in! 4:30 PM Friday with Sarah. See you then! 💈", isUser: false, delay: 5000 }
    ]
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div ref={containerRef}>
                        <div className="md:w-[380px] mx-auto bg-white rounded-[2.5rem] p-4 shadow-2xl border-8 border-slate-900 relative">
                            ...
                            <div className="bg-[#075E54] text-white p-4 rounded-t-2xl flex items-center gap-3 pt-8 pb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold">The Grooming Lounge</h3>
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Fill Your Chairs <span className="text-emerald-400">While You Cut</span>
                        </h2>
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Eliana handles scheduling, cancellations, and style inquiries instantly. Keep your hands on the scissors and let AI handle the phone.
                        </p>

                        <ul className="space-y-4 mb-10">
                            {[
                                "Fill last-minute cancellations",
                                "Handle 'how much is color?' questions",
                                "Rebook recurring clients automatically",
