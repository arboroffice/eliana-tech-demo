...
import { MessageSquare, Check, TrendingUp, Shield } from "lucide-react"

export function FinanceWhatsAppDemo() {
    const [messages, setMessages] = useState<Array<{ text: string, isUser: boolean, time: string }>>([])
    const containerRef = useRef(null)
    const isInView = useInView(containerRef, { once: true, margin: "-100px" })

    const conversation = [
        { text: "What's your current 30-year fixed mortgage rate?", isUser: true, delay: 500 },
        { text: "Today's rate is 6.5% APR for qualified buyers. We also have a first-time buyer program at 6.2%. Would you like a custom quote?", isUser: false, delay: 2000 },
        { text: "Yes, I'm a first-time buyer.", isUser: true, delay: 3500 },
        { text: "Great! I can get you a personalized estimate in about 2 minutes. Just need to ask a few quick questions. Ready?", isUser: false, delay: 5000 },
        { text: "Sure, go ahead.", isUser: true, delay: 6500 },
        { text: "First, what is your estimated household annual income? (This stays private and is just for the estimate)", isUser: false, delay: 7500 }
    ]
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div ref={containerRef}>
                        <div className="md:w-[380px] mx-auto bg-white rounded-[2.5rem] p-4 shadow-2xl border-8 border-slate-900 relative">
                            ...
                            <div className="bg-[#075E54] text-white p-4 rounded-t-2xl flex items-center gap-3 pt-8 pb-4">
                                ...
                                <div>
                                    <h3 className="font-semibold">Apex Financial</h3>
                    ...
                    <div className="text-center lg:text-left">
                        <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
                            Qualify Leads <span className="text-emerald-400">Instantly</span>
                        </h2>
                        <p className="text-xl text-slate-400 mb-8 leading-relaxed">
                            Eliana captures financial leads when intent is highest. Provide instant quotes, pre-qualify prospects, and schedule consultations with your advisors automatically.
                        </p>
