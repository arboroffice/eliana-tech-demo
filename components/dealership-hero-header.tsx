    ...
    <div className="space-y-8">
      ...
      <div className="animate-fade-in-subheading">
        ...
        <div className="flex flex-col items-center gap-2 sm:hidden">
          ...
          <span className="text-3xl font-bold bg-gradient-to-r from-red-500 to-red-400 bg-clip-text text-transparent animate-pulse-glow">
            {counter}+
          </span>
        ...
        <div className="hidden sm:flex items-center justify-center gap-2 sm:gap-3 flex-wrap">
          ...
          <span className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-red-500 to-red-400 bg-clip-text text-transparent animate-pulse-glow">
            {counter}+
          </span>
