  ...
  return (
    <section ref={sectionRef} className="py-16 sm:py-24 relative z-10">
      <div className="bg-white/98 backdrop-blur-2xl rounded-[2rem] shadow-[0_20px_80px_-20px_rgba(0,0,0,0.3)] border border-white/40 relative overflow-hidden mx-4">
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-gradient-to-br from-red-500/20 via-red-500/10 to-transparent rounded-full blur-3xl" />
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-gradient-to-tr from-red-500/20 via-red-500/10 to-transparent rounded-full blur-3xl" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-8 sm:py-12 lg:py-16 relative z-10">
          ...
          >
            <div className="inline-flex items-center px-5 py-2.5 rounded-full bg-gradient-to-r from-slate-100 to-slate-50 border border-slate-200/80 shadow-sm text-slate-700 text-sm font-semibold mb-6">
              <span className="w-2.5 h-2.5 bg-red-500 rounded-full mr-2.5 animate-pulse shadow-lg shadow-red-500/50"></span>
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-4 sm:mb-6 tracking-tight">
              Your AI Team{" "}
              <span className="bg-gradient-to-r from-red-700 via-red-500 to-red-400 bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient">
                Never Sleeps
              </span>
            </h2>
          ...
          >
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-slate-50 to-red-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm">
                    <div className="flex items-center gap-2 mb-3 pb-2 border-b border-slate-100">
                      ...
                      <div className="ml-auto flex gap-1">
                        ...
                        <div className="w-5 h-5 bg-gradient-to-br from-[#dc2626] to-[#991b1b] rounded-full flex items-center justify-center">
                          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2 animate-slide-in-left">
                        <div className="w-6 h-6 rounded-full bg-gradient-to-br from-red-500 to-red-600 flex-shrink-0"></div>
                      ...
                      <div className="flex gap-2 justify-end animate-slide-in-right animation-delay-500">
                        <div className="bg-red-500 rounded-lg rounded-tr-sm px-3 py-1.5 text-xs text-white">
                  ...
                  <div className="space-y-3">
                    <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-red-600 font-bold">Excellent</span>
                      </div>
                      ...
                      <div className="mt-2 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-red-600 to-red-400 rounded-full w-[95%] animate-pulse"></div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-4 border border-slate-200/60 shadow-sm">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-red-600 font-bold">Today</span>
                      </div>
                      <div className="text-2xl font-bold text-slate-900">
                ...
                <div className="bg-gradient-to-br from-slate-50 to-red-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg hover:shadow-xl transition-all duration-300 group">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="relative">
                      <div className="absolute inset-0 bg-red-500 rounded-xl animate-ping opacity-20"></div>
                      <div className="relative w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center shadow-lg shadow-red-500/30">
                        <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                  ...
                  <div className="bg-white rounded-xl p-4 mb-4 border border-slate-200/60 shadow-sm">
                    <div className="text-center mb-3">
                      <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-red-100 text-red-700 rounded-full text-xs font-bold mb-2">
                ...
                <div className="bg-gradient-to-br from-slate-50 to-red-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg hover:shadow-xl transition-all duration-300 group">
                  ...
                  <div className="bg-white rounded-xl p-4 mb-4 border border-slate-200/60 shadow-sm">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 p-2 bg-red-50 rounded-lg animate-slide-in-left">
                      ...
                      <div className="flex items-center gap-2 p-2 bg-red-50 rounded-lg animate-slide-in-left animation-delay-300">
                        <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                        <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 p-2 bg-red-50 rounded-lg border border-red-200 animate-scale-in animation-delay-600">
                        <svg className="w-3 h-3 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <p className="text-xs font-semibold text-red-700">Just booked: 4:00 PM</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="lg:col-span-2 bg-gradient-to-br from-slate-50 to-red-50/30 rounded-2xl p-6 border border-slate-200/60 shadow-lg hover:shadow-xl transition-all duration-300 group">
                  ...
                  <div className="grid sm:grid-cols-3 gap-3 mb-4">
                    ...
                    <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-4 border-2 border-red-200 shadow-md animate-scale-in">
                      ...
                      <p className="text-sm font-bold text-red-800 mb-1">Quote Sent</p>
                      <p className="text-xs text-red-600">Customer notified</p>
                      <p className="text-xs text-red-600 mt-2">via email & SMS</p>
                    </div>
                  </div>
